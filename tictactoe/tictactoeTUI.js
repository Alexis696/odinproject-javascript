...
const GameBoard = (function() {
  ...
  return { board, checkWinner, checkTie };
})();

const displayController = (function() {
  const printBoardTUI = function() {
    console.log(`${GameBoard.board["topL"]} | ${GameBoard.board["topM"]} | ${GameBoard.board["topR"]}
---------
${GameBoard.board["midL"]} | ${GameBoard.board["midM"]} | ${GameBoard.board["midR"]}
---------
${GameBoard.board["botL"]} | ${GameBoard.board["botM"]} | ${GameBoard.board["botR"]}`);
  };

  const runTUI = function() {
    let currentPlayer = {};
